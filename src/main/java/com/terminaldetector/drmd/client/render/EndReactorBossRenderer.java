...
public class EndReactorBossRenderer extends EntityRenderer<EndReactorBossEntity> {
	 ...
	 * no way to check which winding (if either) getEntityTranslucent actually keeps after culling
	 * here, so both are drawn and whichever is front-facing survives regardless.
	 */
