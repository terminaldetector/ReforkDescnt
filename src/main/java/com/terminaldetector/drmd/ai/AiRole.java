...
public enum AiRole {
	ASSAULT("assault", "pressure", 200, 540, 50, 0, 0f, 0.1f, 0f,
			2f, 0.15f, 10f, 0f, 0f, 5000f, DamageClass.ENERGY, false),
	INTERCEPTOR("interceptor", "flank", 150, 860, 30, 0, 0f, 0f, 0f,
			1f, 0.06f, 8f, 0f, 0f, 6000f, DamageClass.ENERGY, false),
	ARTILLERY("artillery", "standoff", 180, 240, 0, 60, 0.2f, 0f, 0.1f,
			20f, 2.5f, 40f, 30f, 120f, 2200f, DamageClass.EXPLOSIVE, true),
	SUPPORT("support", "support", 220, 600, 40, 20, 0f, 0.15f, 0f,
			0f, 0.5f, 0f, 0f, 0f, 0f, DamageClass.ENERGY, false),
	HEAVY_ELITE("heavy_elite", "anchor", 800, 200, 150, 100, 0.2f, 0.2f, 0.3f,
			30f, 3.5f, 90f, 60f, 180f, 1100f, DamageClass.EXPLOSIVE, false),
	// Legacy variants
	MG("mg", "pressure", 120, 480, 0, 0, 0f, 0f, 0f,
			1f, 0.08f, 9f, 0f, 0f, 5000f, DamageClass.KINETIC, false),
	LASER("laser", "flank", 150, 520, 20, 0, 0f, 0.1f, 0f,
			1f, 0.10f, 9f, 0f, 0f, 6000f, DamageClass.ENERGY, false),
	RPG("rpg", "standoff", 150, 400, 0, 20, 0.1f, 0f, 0f,
			15f, 1.8f, 50f, 40f, 140f, 2800f, DamageClass.EXPLOSIVE, false),
	HEAVY("heavy", "anchor", 450, 200, 40, 40, 0.15f, 0.1f, 0.2f,
			25f, 2.2f, 90f, 60f, 180f, 1100f, DamageClass.EXPLOSIVE, false),
	SEEKER("seeker", "flank", 280, 500, 30, 0, 0f, 0.05f, 0f,
			18f, 2.0f, 70f, 40f, 160f, 2200f, DamageClass.EXPLOSIVE, true),
	GRAV("grav", "pressure", 150, 450, 20, 0, 0f, 0f, 0f,
			10f, 1.5f, 25f, 0f, 0f, 3000f, DamageClass.EXOTIC, false);
	...
	AiRole(String id, String ai, float hullHp, float speed, float shield, float armor,
		   ...
		   DamageClass cls, boolean homing) {
