...
-- =========================================================
SWEP.PrintName      = "D6: РПГ-сканер"
SWEP.Author         = "Descent 6DOF"
SWEP.Instructions   = "ЛКМ: заспавнить   ПКМ: сразу 2"
...
local function SpawnRPG(ply, pos)
    if SpawnEnemyDrone then SpawnEnemyDrone(ply,"npc_cscanner","rpg")
        ...
        npc:SetColor(Color(40,100,255)); npc.D6_Variant="rpg"
...
if SERVER then
    function SWEP:DoSpawn(ply, pos) SpawnRPG(ply, pos) end
    function SWEP:DoSecondary(ply)
        ...
        for i=1,2 do SpawnRPG(ply,p+sa*200+Vector(math.Rand(-40,40),math.Rand(-40,40),0)) end
    end
end
