...
./scripts/package_mcpe_master.sh dist 1.0.4
...
MCPE Master / Bedrock
  A) drmd-6dof-mcpe-master-1.0.4.mcaddon — открыть в игре
  B) drmd-6dof-mcpe-master-1.0.4.zip — вручную в games/com.mojang
