...
| `src/main/java/com/terminaldetector/drmd/vendor/immptl/ImmPtlIntBox.java` | Immersive Portals 6.0.6, `qouteall.q_misc_util.my_util.IntBox` | Apache-2.0 | Yes — see the header |
