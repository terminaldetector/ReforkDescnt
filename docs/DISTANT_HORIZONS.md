...
One thing did come back, rebuilt: the **voxel horizon** (1.1.3, widened in 1.1.4). It is not a far
LOD of the real world — it is a procedural map of the surface plus silhouettes of what the mod has
built, compressed toward the camera, for the views DH cannot serve well: straight down from nine
hundred blocks up, and the kilometres past the chunk edge seen from altitude, both over ground the
client was never sent. See [`VOXEL_HORIZON.md`](VOXEL_HORIZON.md), and turn it off there if you
would rather see DH's real LODs.
