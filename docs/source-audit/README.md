...
| `algorithm-map.md` | Алгоритмы под LGPL/GPL — описанием, для своей реализации | нет |

Первые три не требовали исходников доноров и сделаны. Последние три требуют, форки подключены,
работа идёт по порядку из `repository-map.md`.
